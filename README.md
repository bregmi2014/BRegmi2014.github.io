# 🧑‍💻 My Developer Portfolio – Powered by Reactfolio

Welcome to my personal portfolio website! This space is where I showcase my projects, skills, articles, and a few unconventional thoughts from the philosophical corners of my mind.

Built with the awesome [Reactfolio](https://github.com/tharinduliyanage/reactfolio) template by [Tharindu Nayanajith](https://github.com/tharinduliyanage), this site is fully customizable, responsive, and designed to grow as I do — as a developer, a thinker, and everything in between.
...
Big shout-out to [Tharindu Nayanajith](https://github.com/tharinduliyanage) for creating and open-sourcing the [Reactfolio template](https://github.com/tharinduliyanage/reactfolio). It’s a sleek and efficient foundation that made building this portfolio a joy.
...
- 🎯 SEO-ready with metadata configurations
